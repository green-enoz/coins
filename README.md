...
Чтобы включить возможность редактирования, перейдите в [Общие Настройки] и активируйте [Режим редактирования].

Перед добавлением монеты убедитесь, что:
- монета существует,
...
Вы также можете добавить новую монету на основе уже существующей, нажав кнопку [Сохранить копию].
Рекомендуется указывать ссылку на страницу Центрального Банка с описанием монеты.
...
- Подать заявку на роль редактора можно через [каталог] - [настройки] - [список редакторов] - [подать заявку]. Автор каталога может принять/отклонить заявку (для этого нужно длительно нажать на нее, чтобы открылось диалоговое окно подтверждения). Если автора нет, это могут сделать разработчики.
- Чтобы добавить монету из раздела [Общие черновики], откройте [Общие черновики], выберите монету, нажмите [редактировать], затем [переместить в локальную БД]. Монета будет скопирована на ваш телефон и удалена из [Общих черновиков]. Далее вам нужно будет опубликовать изменения каталога.
- Чтобы изменения в каталоге стали доступны всем пользователям, нажмите [каталог] - [настройки] - [опубликовать].
- Удалять уже опубликованные монеты нельзя, чтобы у пользователей, пользующихся каталогом, не исчезали монеты.
