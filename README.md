...
### Редакторы
Редакторы каталога могут добавлять и изменять монеты в каталоге, а также перемещать монеты из [Общие черновики] в каталог.

- Подать заявку на роль редактора можно через [каталог] - [настройки] - [список редакторов] - [подать заявку]. Автор каталога и разработчик могут принять заявку, для этого нажмите и удерживайте заявку.
- Чтобы добавить монету из [Общие черновики], откройте [Общие черновики], выберите монету, нажмите [редактировать], затем [переместить в локальную БД]. Монета будет скопирована на ваш телефон и удалена из [Общие черновики]. Далее вам нужно будет опубликовать изменения каталога.
